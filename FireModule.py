...
def get_fire_module(X, filters, layer_id):
    ...
    X_1 = Conv2D(filters=_filters[1], kernel_size=(1, 1), activation='relu', name=layer_name+expand_1)(X)
    X_3 = Conv2D(filters=_filters[2], kernel_size=(3, 3), activation='relu', padding='same', name=layer_name+expand_3)(X)
